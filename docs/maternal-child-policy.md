...
- 《国家免疫规划疫苗儿童免疫程序及说明（2026年版）》（2026 年 6 月），作为出生证明后续预防接种提醒和补种核验的规则来源。
...
| 2026 版国家免疫规划明确儿童接种年龄、剂次、途径、剂量、补种原则和特殊健康状态者接种建议 | 出生证明归集后生成应种日期、下一剂次、逾期未种、30 天内到期和补种核验提醒 | `immunization-schedule.js`、`immunization.html`、`immunization:readiness` |
...
- 形成 2026 版国家免疫规划的接种覆盖、逾期未种、30 天内到期和补种核验预警。
...
- 疾控免疫规划信息系统、接种单位预约系统、疫苗库存和接种记录回写接口。
