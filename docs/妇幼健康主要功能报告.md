...
| 出生人口健康管理 | 个人用户端 | `citizen.html` | `birthCertificates`, `personalRecords` | 居民查看家庭成员出生证明、妇幼入册、新生儿访视、筛查、接种、低体重儿专案和儿童保健接续 | `renderBirthHealth`, `renderMaternalChildContinuity`, `lifecycle-summary` |
...
- 个人用户端负责查看本人及家庭成员授权范围内的出生证明、出生健康记录和妇幼连续服务任务，不出现卫健监管或机构办理功能。
...
- `personalRecords`：居民端出生健康与连续服务记录。
...
| 居民生命周期接续 | 个人用户端 | 出生证明接续到新生儿访视、筛查、接种、儿童保健和个人健康档案 | `role:citizen`, `lifecycle-summary` |
