...
| 出生医学证明办理 | 医疗机构端 | `institution.html` | `birthCertificates`, `birthCertificateForms` | 登记新生儿和父母信息，办理首次签发、换发、补发、签发、上报入册、材料核验，并展示公安待共享、妇幼待入册和质控补正风险卡片 | `birth-certificate-form`, `/api/birth-certificates`, `submitBirthCertificate`, `actionButton`, `role:institution-risk-metrics` |
