...
| [Playwright E2E 采用统一浏览器策略与独占测试服务](./2026-08-23-playwright-e2e-isolation-and-browser-policy.md) | Accepted | Playwright Chromium、在线 Service Worker 隔离、PWA 专项、动态端口与当前 50 项套件分区 |
