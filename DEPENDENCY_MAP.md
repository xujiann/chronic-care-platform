...
- E2E 依赖方向为 `npm test:e2e → root runner(59) / resident owned runner(13) / PWA runner(3) → 动态回环端口 + 独立临时
...
- browser-e2e 本地与 CI 均由标准 `test:e2e` 顺序执行在线根 59、居民 13、PWA 3 项，共 75 项；三阶段各自分配
