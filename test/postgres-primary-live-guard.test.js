...
test("primary entry invokes all four real files serially and preserves the inherited CI contract", () => {
  let invocation;
  ...
  assert.deepEqual(TESTS, ["test/postgres-primary-live-contract.test.js", "test/postgres-primary-live-concurrency.test.js", "test/postgres-primary-identity-live.test.js", "test/postgres-primary-checkpoint-live.test.js"]);
