...
test("health dashboard exposes the aggregate application entry and API contract", () => {
  ...
  assert.match(js, /buildDashboardIndicatorCenter/);
  assert.match(js, /renderIndicatorCenter/);
  assert.match(js, /bindIndicatorCenterFilters/);
  assert.match(js, /currentIndicatorDimension/);
  assert.match(js, /reformCategories/);
  assert.match(js, /aggregationEntrypoints/);
  assert.match(js, /data-indicator-drilldown/);
  assert.match(js, /buildDashboardProductionReadinessGate/);
  assert.match(js, /renderProductionReadinessGate/);
  assert.match(js, /buildDashboardProductionAcceptanceRouting/);
  assert.match(js, /buildDashboardProductionBackendGoLiveChecklist/);
  assert.match(js, /data-production-acceptance/);
  assert.match(js, /data-production-backend-go-live/);
  assert.match(js, /bindBackendGoLiveStatus/);
  assert.match(js, /bindBackendGoLiveReset/);
  assert.match(js, /currentBackendGoLiveStatus/);
  assert.match(js, /backendGoLiveStatus/);
  assert.match(js, /backendGoLiveFiltered/);
  assert.match(js, /acceptanceRouting/);
  assert.match(js, /backendGoLiveChecklist/);
  ...
  assert.match(js, /renderJurisdictionDetail/);
  assert.match(js, /bindJurisdictionScopeFilters/);
  assert.match(js, /currentJurisdictionDetail/);
  assert.match(js, /buildDashboardActionClosureTrend/);
  assert.match(js, /renderActionClosureTrend/);
  ...
  assert.match(read("portal.css"), /jurisdiction-detail-card/);
  assert.match(read("portal.css"), /action-trend-card/);
  ...
  assert.match(read("portal.css"), /indicator-center-grid/);
  assert.match(read("portal.css"), /indicator-category-grid/);
  assert.match(read("portal.css"), /indicator-entry-grid/);
  assert.match(read("portal.css"), /indicator-card/);
...
test("deployment baseline documents scripts and environment template", () => {
  ...
  assert.match(read("docs/health-dashboard-function-roadmap-report.md"), /卫生健康综合管理服务系统功能与后续开发报告/);
  assert.match(read("docs/health-dashboard-function-roadmap-report.md"), /```mermaid/);
  assert.match(read("docs/health-dashboard-function-roadmap-report.md"), /系统架构图/);
  assert.match(read("docs/health-dashboard-function-roadmap-report.md"), /已完成功能/);
  assert.match(read("docs/health-dashboard-function-roadmap-report.md"), /P0：真实上线硬门禁/);
  assert.match(read("docs/health-dashboard-function-roadmap-report.md"), /P1：行政监管业务增强/);
  assert.match(read("docs/health-dashboard-function-roadmap-report.md"), /P2：长期运行优化/);
  assert.match(read("scripts/release-artifact-manifest.js"), /health-dashboard-function-roadmap/);
  assert.match(read("docs/health-dashboard-backend-go-live-checklist.md"), /生产后端上线准备清单/);
  assert.match(read("docs/health-dashboard-backend-go-live-checklist.md"), /真实上线需要生产级后端/);
  assert.match(read("docs/health-dashboard-backend-go-live-checklist.md"), /```mermaid/);
  assert.match(read("docs/health-dashboard-backend-go-live-checklist.md"), /生产数据库/);
  assert.match(read("docs/health-dashboard-backend-go-live-checklist.md"), /统一身份/);
  assert.match(read("docs/health-dashboard-backend-go-live-checklist.md"), /AUDIT_EXPORT_PATH/);
  assert.match(read("docs/health-dashboard-backend-go-live-checklist.md"), /SIEM_ENDPOINT/);
  assert.match(read("scripts/release-artifact-manifest.js"), /health-dashboard-backend-go-live/);
  assert.match(read("docs/health-dashboard-indicator-center-report.md"), /卫生健康综合管理服务系统指标中心报告/);
  assert.match(read("docs/health-dashboard-indicator-center-report.md"), /公立医院绩效考核/);
  assert.match(read("docs/health-dashboard-indicator-center-report.md"), /等级评审/);
  assert.match(read("docs/health-dashboard-indicator-center-report.md"), /资源效率/);
  assert.match(read("docs/health-dashboard-indicator-center-report.md"), /智慧医院管理线汇聚入口/);
  assert.match(read("docs/health-dashboard-indicator-center-report.md"), /\/api\/health-dashboard\/summary/);
  assert.match(read("docs/health-dashboard-indicator-center-report.md"), /\/api\/health-dashboard\/production-readiness/);
  assert.match(read("scripts/release-artifact-manifest.js"), /health-dashboard-indicator-center/);
  assert.match(read("scripts/deploy-check.js"), /health-dashboard-indicator-center-report\.md/);
