...
test("digital hospital v0.11 prototype is publishable from GitHub Pages", () => {
  ...
  assert.match(standardsEntry, /href="\.\/digital-hospital-standard-platform\/">新标准平台 v0\.11/);
  ...
  assert.match(app, /digitalHospitalMvpState:v0\.11/);
