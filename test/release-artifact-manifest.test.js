...
test("release artifact manifest indexes reports templates commands and evidence", () => {
  ...
  assert.equal(report.artifacts.some((item) => item.id === "digital-hospital-platform-function-description-20260726" && item.command === "release:manifest" && item.markdown === "docs/数智医院标准平台功能说明-2026-07-26.md" && item.evidence === "docs/数智医院标准平台功能说明-2026-07-26.md"), true);
  ...
  assert.equal(report.artifacts.some((item) => item.id === "pilot-evidence-repository-readiness" && item.command === "pilot-evidence:readiness" && item.markdown === "release/pilot-evidence-repository-readiness.md" && item.evidence === "/api/pilot-evidence"), true);
  ...
  assert.equal(report.artifacts.some((item) => item.id === "postgres-primary-read" && item.command === "postgres:primary-read-rehearsal" && item.evidence === "/api/production-database/primary-read-rehearsal"), true);
  assert.equal(report.artifacts.some((item) => item.id === "postgres-production-adapter" && item.command === "postgres:adapter-status" && item.evidence === "/api/production-database/adapter"), true);
  ...
  assert.equal(report.artifacts.some((item) => item.id === "digital-hospital-pilot" && item.command === "digital-hospital:pilot-readiness" && item.markdown === "release/digital-hospital-pilot-readiness-report.md" && item.evidence === "digital-hospital-evaluation.html"), true);
  assert.equal(report.artifacts.some((item) => item.id === "research-project-acceptance" && item.command === "research-project:acceptance" && item.markdown === "release/research-project-acceptance.md" && item.evidence === "/api/research-project/acceptance-center"), true);
  assert.equal(report.artifacts.some((item) => item.id === "research-expert-consultation" && item.command === "research-project:expert-consultation" && item.markdown === "release/research-expert-consultation.md" && item.evidence === "/api/research-project/expert-consultation"), true);
  assert.equal(report.artifacts.some((item) => item.id === "research-rater-consistency" && item.command === "research-project:rater-consistency" && item.markdown === "release/research-rater-consistency.md" && item.evidence === "/api/research-project/rater-consistency"), true);
...
test("release artifact manifest renders and writes artifacts", (t) => {
  ...
  assert.match(markdown, /PostgreSQL verified primary-read rehearsal/);
  assert.match(markdown, /PostgreSQL evidence-gated production adapter/);
