...
test("release artifact manifest indexes reports templates commands and evidence", () => {
  ...
  assert.equal(report.artifacts.some((item) => item.id === "pilot-evidence-repository-readiness" && item.command === "pilot-evidence:readiness" && item.markdown === "release/pilot-evidence-repository-readiness.md" && item.evidence === "docs/pilot-evidence-repository.md"), true);
