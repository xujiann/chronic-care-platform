...
test("release artifact manifest indexes reports templates commands and evidence", () => {
  ...
  assert.equal(report.artifacts.some((item) => item.id === "hospital-operations-flow" && item.markdown === "docs/hospital-operations-flow.md"), true);
  assert.equal(report.artifacts.some((item) => item.id === "hospital-operations-development-report" && item.markdown === "docs/hospital-operations-development-report.md"), true);
