...
test("CI maps standard gates without renaming required checks or weakening test:all", () => {
  ...
  assert.match(workflow, /npm run first-release:migration-portfolio:verify/);
  ...
  assert.equal(pkg.scripts["first-release:migration-portfolio:verify"], "node scripts/first-release-migration-portfolio.js");
