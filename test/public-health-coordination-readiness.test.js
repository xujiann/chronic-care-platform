...
test("coordination readiness accepts the complete eight-domain functional increment", () => {
  ...
  assert.equal(report.formalGoLiveState, "blocked-until-t00-action-persistence-and-site-evidence-verified");
  assert.equal(report.summary.checks, 22);
  assert.equal(report.summary.passed, 22);
