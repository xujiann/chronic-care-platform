...
test("deploy check report covers release-critical snapshot gates", () => {
  ...
  [
    ...
    "file:scripts/chronic-followup-dispatch-worker.js",
    "file:scripts/postgres-primary-transition-readiness.js",
    "file:src/citizen-chronic/followup-dispatch-outbox.js",
    "file:src/citizen-chronic/followup-dispatch-activation-provider.js",
    "file:deploy/chronic-followup-dispatch-worker.service.template",
    ...
    "file:platform-go-live-slices.js",
    "file:scripts/platform-go-live-slices.js",
    ...
    "file:docs/internet-nursing-highlight-center.md",
    "file:internet-nursing-highlights.js",
    "file:production-go-no-go.js",
    "file:production-go-no-go-ui.js",
    "file:scripts/production-go-no-go-readiness.js",
    "file:docs/production-go-no-go-command-center.md",
    ...
    "package:platformGoLiveSlices",
    "package:platformStandardsLedgers",
    "package:productionGoNoGoReadiness",
    ...
    "snapshot:internetNursing",
    "snapshot:internetNursingAuth",
    "module:internetNursingHighlights",
    "snapshot:multiPractice",
    "docs:chronicLaunchCore",
    "docs:chronicInformatizationSources",
    "package:chronicFollowupDispatchWorker",
    ...
    "manifest:diseasePaymentReadiness",
    ...
    "manifest:productionGoNoGoReadiness",
    ...
    "manifest:platformStandardsLedgers",
