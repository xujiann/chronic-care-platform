...
- 仍开放：32 个 scoped API 中 17 个需要 repository behavior review；38 个数据引用中 19 个需要 owner/governance review。另两项已机器区分为 T05 exact owner contract 与 T00 derived read model，不伪装为顶层 collection。
