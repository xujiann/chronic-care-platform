...
| DOC-001 | 2026-08-24 | 关闭时为 267 份；当前 286 份 Markdown 以路径和 ADR 台账唯一分类为 216 current、68 snapshot、2 superseded；不删除历史证据 | 闭集路径/分类摘要、规则重叠、ADR status、当前事实和 snapshot 内容聚合摘要失败关闭 |
