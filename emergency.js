...
async function submitProductionForm(event){
  ...
  const pathByForm={"endpoint-probe-form":`/production/endpoints/${encodeURIComponent(id)}/probe`,"drill-complete-form":`/production/drills/${encodeURIComponent(id)}/complete`,"requirement-sign-form":`/production/requirements/${encodeURIComponent(id)}/sign`,"quality-validate-form":`/production/quality/events/${encodeURIComponent(id)}/validate`,"quality-resolve-form":`/production/quality/issues/${encodeURIComponent(id)}/resolve`,"alert-action-form":`/production/alerts/${encodeURIComponent(id)}/actions`,"cutover-approval-form":`/production/approvals/${encodeURIComponent(id)}/sign`,"handoff-accept-form":`/production/handoffs/${encodeURIComponent(id)}/accept`,"command-brief-form":`/production/command-briefs/${encodeURIComponent(id)}/actions`,"observation-record-form":`/production/observations/${encodeURIComponent(id)}/record`,"launch-incident-form":"/production/incidents","incident-resolve-form":`/production/incidents/${encodeURIComponent(id)}/resolve`};
...
function renderProductionCenter(){
  ...
  document.querySelector("#production-requirements").innerHTML=center.requirements.map((row)=>productionRow(`${row.id} · ${row.title}`,row.status,`${row.owner} · ${row.evidenceRef||"现场待签"}`)).join("");
