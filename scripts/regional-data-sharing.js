...
function buildRegionalDataSharingReport(options = {}) {
  ...
  const checks = [
    ...
    { id: "regional:aboutSiteEvidenceActions", passed: /data-regional-about-section="site-evidence-actions"/.test(about) && /现场交付物/.test(about) && /联调样例/.test(about) && /验收证据/.test(about) && /AUDIT_EXPORT_PATH/.test(about) && /RTO\/RPO/.test(about), detail: "site evidence actions documented" },
