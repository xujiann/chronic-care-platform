...
function buildRegionalDataSharingReport(options = {}) {
  ...
  const checks = [
    ...
    { id: "regional:functionRoadmapUi", passed: /data-regional-section="function-roadmap"/.test(html) && /regional-function-roadmap/.test(html) && /renderRegionalFunctionRoadmap/.test(client) && /责任部门/.test(client) && /下一步计划开发功能/.test(client) && /市级平台数据治理组/.test(client) && /接口联调组/.test(client), detail: "main page function owners and planned features present" },
    ...
    { id: "regional:aboutFunctionRoadmap", passed: /data-regional-about-section="function-roadmap"/.test(about) && /现有功能及责任部门/.test(about) && /下一步计划开发功能/.test(about) && /市级平台数据治理组/.test(about) && /安全管理岗/.test(about), detail: "implemented functions, owners and planned features documented" },
