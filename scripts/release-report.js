...
function renderMarkdown(report) {
  ...
  return [
    ...
    "See `public-health-final-readiness-report.json` and `public-health-final-readiness-report.md` for eight-lane coordination, signed outbox callbacks, worker leases, full keyring rotation verification, server-bound endpoint probe receipts, emergency-revocation quarantine, and the retained production boundary.",
