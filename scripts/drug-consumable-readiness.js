...
function buildDrugConsumableReadinessReport(options = {}) {
  ...
  const checks = [
    ...
    { id: "drug-consumable:traceability-evidence", passed: /buildDrugTraceabilityEvidenceChecklist/.test(server) && /traceabilityEvidenceChecklist/.test(server) && /renderTraceabilityEvidenceChecklist/.test(insuranceJs) && /renderInstitutionTraceabilityEvidenceChecklist/.test(institutionJs) && /renderDrugTraceabilityEvidenceChecklistRow/.test(workbenchJs), detail: "traceability evidence checklist is generated by API and rendered on insurance, institution and workbench pages" },
