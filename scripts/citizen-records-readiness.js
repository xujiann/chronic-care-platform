...
function assessCitizenRecordsReadiness(options = {}) {
  ...
  const softwareChecks = [
    ...
    { id: "acceptance-documentation", label: "居民验收标准与外部依赖", passed: /第十二增量/.test(documentation) && /## 外部依赖/.test(documentation) }
  ];
  ...
  const integrationChecks = [
    ...
    },
    {
      ...
      passed: /citizen-records-v2\.js\?v=20260723care8/.test(serviceWorker) && /citizen\.js\?v=20260723care8/.test(serviceWorker)
    }
  ];
