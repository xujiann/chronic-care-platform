...
function buildHospitalOperationsReadinessReport(options = {}) {
  ...
  const checks = [
    ...
    { id: "hospitalOps:goLiveGates", passed: /buildOperationsGoLiveGates/.test(serverSource) && /\/api\/operations\/go-live-gates/.test(serverSource) && /operation-go-live-gates/.test(operationsHtml) && /renderGoLiveGates/.test(operationsJs), detail: "go-live gate checklist API and panel cover payload, audit, monitoring, and DR evidence" },
