...
function buildInsurancePaymentAcceptance(options = {}) {
  ...
  const workflows = [
    ...
    { id: "insurance-settlement", label: "医保核心结算", ready: checkById(diseasePayment, "settlement") && checkById(diseasePayment, "settlement-core-correction"), evidence: ["formal-grouping-gate", "integer-fen-contract", "trusted-core-callback", "digest-bound-return-requirements", "correction-sla", "resubmission-identity-rotation", "multi-cycle-return-ledger", "hash-ledger"] },
