...
function buildInsurancePaymentAcceptance(options = {}) {
  ...
  const workflows = [
    ...
    { id: "monthly-settlement", label: "月度结算", ready: checkById(diseasePayment, "settlement") && checkById(diseasePayment, "settlement-sla"), evidence: ["frozen-batch", "30-working-day-sla", "difference-resolution", "payment-receipt"] },
