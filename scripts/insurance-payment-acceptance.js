...
function buildInsurancePaymentAcceptance(options = {}) {
  ...
  const workflows = [
    { id: "online-payment-refund", label: "在线支付退费", ready: capabilityById(financialGateway, "online-refund-closed-loop") && capabilityById(financialGateway, "online-refund-sla-operations"), evidence: ["dual-domain-review", "decision-bound-resubmission", "fresh-correction-evidence", "immutable-review-history", "ledger-guarded-transitions", "trusted-callback", "provider-reversal", "phase-sla", "redacted-exception-queue", "daily-reconciliation", "voucher-close"] },
