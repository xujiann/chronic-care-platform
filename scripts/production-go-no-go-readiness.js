...
function buildProductionGoNoGoReadiness(options = {}) {
  ...
  const checks = [
    ...
    check("goNoGoReadiness:prerequisites", ["goNoGo:siteAcceptances", "goNoGo:securityOpinion", "goNoGo:launchSmoke", "goNoGo:cutoverChecklist", "goNoGo:drSignoff"].every((id) => model.includes(id)), "five production prerequisite gates modeled"),
