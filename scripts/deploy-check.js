...
function buildDeployCheckReport(options = {}) {
  ...
  const checks = [
    ...
    { name: "api:chronicPublicHealthLoop", ok: serverSource.includes("/api/chronic/public-health-loop") && institutionSource.includes("loadChronicPublicHealthLoop") && institutionSource.includes("renderChronicPublicHealthLoop") && institutionHtml.includes("public-health-loop-stages"), detail: "chronic public health monitor-alert-dispatch-intervention-followup-summary loop is wired" },
