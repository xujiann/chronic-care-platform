...
function buildDeployCheckReport(options = {}) {
  ...
  const checks = [
    ...
    { name: "snapshot:qualitySafety", ok: Array.isArray(data.qualitySafetyEvents) && data.qualitySafetyEvents.length >= 3 && Array.isArray(data.qualityRectificationOrders) && data.qualityRectificationOrders.length >= 1 && Array.isArray(data.qualitySafetySiteSignoffs) && data.qualitySafetySiteSignoffs.length >= 6, detail: `${data.qualitySafetyEvents?.length || 0} events, ${data.qualityRectificationOrders?.length || 0} rectifications, ${data.qualitySafetySiteSignoffs?.length || 0} site signoffs` },
