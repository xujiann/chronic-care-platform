...
function buildDeployCheckReport(options = {}) {
  ...
  const checks = [
    ...
    { name: "docs:platformDevelopmentReport20260711", ok: ["本轮主要开发成果", "正式生产前已实现的主要标准平台功能", "验证证据", "当前生产阻断项", "下一步开发计划", "P0：0-30 天", "P1：31-60 天", "P2：61-90 天", "301/301", "230/230"].every((marker) => platformDevelopmentReportDoc.includes(marker)), detail: "dated platform development report records delivered production adapter foundations, verification evidence, blockers and 30/60/90-day plan" },
