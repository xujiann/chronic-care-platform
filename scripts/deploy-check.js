...
function buildDeployCheckReport(options = {}) {
  ...
  const checks = [
    ...
    { name: "docs:platformDevelopmentReport20260711", ok: ["本轮主要开发成果", "生产可观测性与 SIEM 告警闭环", "正式生产前已实现的主要标准平台功能", "验证证据", "当前生产阻断项", "下一步开发计划", "P0：0-30 天", "P1：31-60 天", "P2：61-90 天", "304/304", "233/234", "195/195"].every((marker) => platformDevelopmentReportDoc.includes(marker)), detail: "dated platform development report records delivered production adapter foundations, observability alert routing, verification evidence, blockers and 30/60/90-day plan" },
