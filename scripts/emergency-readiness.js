...
function buildEmergencyReadinessReport(options = {}) {
  const sources = options.sources || { html:read("emergency.html"), js:read("emergency.js"), service:read("emergency-service.js"), production:read("emergency-production.js"), server:read("server.js"), apiTest:read("test/emergency-api.test.js"), docs:`${read("docs/院前急救协同信息系统立项与标准基线-2026-07-15.md")}\n${read("docs/院前急救生产前上线控制说明.md")}\n${read("docs/emergency-sos-aed.md")}`, diagrams:read("docs/院前急救系统拓扑与流程图集.md"), package:read("package.json") };
