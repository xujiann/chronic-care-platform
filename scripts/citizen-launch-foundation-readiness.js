...
function buildCitizenLaunchFoundationReadiness(options = {}) {
  ...
  const checks = [
    ...
    },
    {
      ...
      passed: hasAll(citizenJs + mobilePreviewRuntime, [/citizenClientChannels/, /mini-program/, /clientChannelEntry/, /copyClientEntry/, /copyLaunchMaterials/, /copyTextToClipboard/, /data-copy-launch-materials/, /isLaunchReviewMode/, /launch-review-mode/, /launch=1/, /launchChecklist/, /productionMaterials/, /productionMaterialSummary/, /client-material-summary/, /client-production-materials/, /owner/, /acceptance/, /SMS_GATEWAY_URL/, /OIDC/, /previewParams\.get\("client"\)/]),
