...
const ARTIFACTS = [
  ...
  ["regional-site-evidence-readiness", "cutover", "Digest-pinned regional site evidence admission and five-scope review", "release/regional-site-evidence-readiness.json", "release/regional-site-evidence-readiness.md", "regional:evidence", "/api/regional/deployments/:regionCode/dossier"],
