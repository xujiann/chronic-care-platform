...
const ARTIFACTS = [
  ...
  ["digital-hospital-platform-function-description-20260726", "governance", "Digital hospital standards platform complete function description", "docs/数智医院标准平台功能说明-2026-07-26.md", "docs/数智医院标准平台功能说明-2026-07-26.md", "release:manifest", "docs/数智医院标准平台功能说明-2026-07-26.md"],
  ...
  ["pilot-evidence-repository-readiness", "cutover", "Versioned pilot evidence batches, independent review and tamper-evident acceptance packs", "release/pilot-evidence-repository-readiness.json", "release/pilot-evidence-repository-readiness.md", "pilot-evidence:readiness", "/api/pilot-evidence"],
  ...
  ["research-project-acceptance", "research", "Grant requirements, deliverables, quantitative metrics, milestones and independently reviewed evidence traceability", "release/research-project-acceptance.json", "release/research-project-acceptance.md", "research-project:acceptance", "/api/research-project/acceptance-center"],
  ["research-expert-consultation", "research", "Anonymized expert consultation rounds, response coefficient, I-CVI and AHP consistency evidence", "release/research-expert-consultation.json", "release/research-expert-consultation.md", "research-project:expert-consultation", "/api/research-project/expert-consultation"],
  ["research-rater-consistency", "research", "Anonymized inter-rater consistency batches with Fleiss Kappa and ICC(A,1) evidence", "release/research-rater-consistency.json", "release/research-rater-consistency.md", "research-project:rater-consistency", "/api/research-project/rater-consistency"],
