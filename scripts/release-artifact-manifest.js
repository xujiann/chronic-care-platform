...
const ARTIFACTS = [
  ...
  ["release-evidence-provenance", "release", "Commit-bound freshness and digest provenance for critical release evidence", "release/release-evidence-provenance.json", "docs/平台下一阶段六迭代交付报告-2026-08-16.md", "release:evidence-provenance", "npm run release:evidence-provenance:verify"],
  ["platform-runtime-composition", "governance", "Startup-only runtime provider context and route composition baseline", "src/http/platform-runtime-composition.js", "docs/平台下一阶段六迭代交付报告-2026-08-16.md", "routes:check", "src/http/platform-request-handler.js"],
  ["data-collection-governance", "data", "Complete authoritative governed-system and legacy non-authoritative collection inventory", "release/data-collection-governance.json", "release/data-collection-governance.md", "data:collection-governance", "config/domain-data-ownership.json"],
  ["platform-nonfunctional-readiness", "governance", "Frontend server composition accessibility and regression budget readiness", "release/platform-nonfunctional-readiness.json", "release/platform-nonfunctional-readiness.md", "platform:nonfunctional", "config/platform-nonfunctional-budgets.json"],
  ["platform-productization-readiness", "governance", "Six-iteration platform productization local gate with production fail-closed boundary", "release/platform-productization-readiness.json", "release/platform-productization-readiness.md", "productization:readiness", "/api/platform/productization/center"],
  ...
  ["regional-site-deployment", "deployment", "Secretless multi-region site deployment plan and validation templates", "config/regional-replication-sites.json", "docs/多地区部署功能清单与操作指南.md", "regional:deploy-plan", "deploy/validation/README.md"],
  ["regional-release-governance", "governance", "Immutable regional release lifecycle, evidence and rollback registry", "config/regional-release-registry.json", "docs/地区发布治理与回滚操作指南-2026-08-06.md", "regional:release-governance", "docs/地区发布治理与回滚操作指南-2026-08-06.md"],
  ["regional-operations-readiness", "operations", "Multi-region fleet inventory and controlled probe readiness", "release/regional-operations-readiness.json", "release/regional-operations-readiness.md", "regional:operations", "/api/regional/deployments"],
  ["regional-configuration-readiness", "governance", "Value-free regional configuration admission audit", "release/regional-configuration-readiness.json", "release/regional-configuration-readiness.md", "regional:configuration", "/api/regional/deployments"],
  ["regional-site-evidence-readiness", "cutover", "Digest-pinned, Ed25519 dual-signed and lifecycle-accepted regional site evidence admission", "release/regional-site-evidence-readiness.json", "release/regional-site-evidence-readiness.md", "regional:evidence", "/api/regional/deployments/:regionCode/dossier"],
  ["regional-site-evidence-lifecycle", "governance", "Append-only regional evidence submission, review, return, acceptance, revocation and supersession ledger", "deploy/regional-site-evidence-lifecycle-registry.template.json", "docs/地区配置准入与投产档案操作指南-2026-08-07.md", "regional:evidence-lifecycle", "/api/regional/deployments/:regionCode/dossier"],
  ["regional-cutover-dossier", "cutover", "Single-region cutover dossier with evidence-gated candidate controls", "release/regional-cutover-dossier.json", "release/regional-cutover-dossier.md", "regional:dossier", "/api/regional/deployments/:regionCode/dossier"],
  ["regional-cutover-workbench", "operations", "Minimized fleet cutover workbench without site evidence bodies or business data", "src/platform/regional/regional-cutover-workbench.js", "platform.html", "regional:test", "/api/regional/cutover-workbench"],
  ["regional-pilot-readiness", "cutover", "Configured regional chronic follow-up and referral closed-loop pilot foundation", "release/regional-pilot-readiness.json", "release/regional-pilot-readiness.md", "regional:pilot", "/api/regional/pilot-program"],
  ["regional-replication-exercise", "deployment", "Second-region same-core isolation and replication exercise", "release/regional-replication-exercise.json", "release/regional-replication-exercise.md", "regional:replication", "docs/多地区产品线四线六迭代交付报告-2026-08-06.md"],
  ["postgres-primary-storage-contract", "data", "Evidence-gated PostgreSQL primary storage contract, driver and schema", "deploy/postgres-primary-storage-schema.sql", "docs/postgresql-primary-storage-contract.md", "postgres:primary-storage-contract:check", "/api/production-database/adapter"],
  ...
  ["t10-clinical-blood-independent-gate", "cutover", "T10 clinical blood shared-runtime production gate (legacy artifact ID)", "docs/clinical-blood-production-readiness.md", "docs/clinical-blood-production-readiness.md", "t10:clinical-blood:readiness", "/api/t10-specialty/modules/clinical-blood/readiness"],
