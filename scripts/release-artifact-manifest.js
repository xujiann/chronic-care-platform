...
const ARTIFACTS = [
  ...
  ["regional-data-sharing", "regional-data-sharing", "Regional diagnosis data sharing report", "release/regional-data-sharing-report.json", "release/regional-data-sharing-report.md", "regional-data-sharing:report", "/api/regional-data-sharing/handoff-report"],
  ["regional-referral-overlap", "regional-data-sharing", "Regional sharing and referral overlap report", "release/regional-referral-overlap-report.json", "release/regional-referral-overlap-report.md", "regional-referral:overlap", "release/regional-referral-overlap-report.md"],
