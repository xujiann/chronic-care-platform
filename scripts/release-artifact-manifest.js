...
const ARTIFACTS = [
  ...
  ["health-dashboard-function-roadmap", "dashboard", "Health dashboard function and roadmap report", "docs/health-dashboard-function-roadmap-report.md", "docs/health-dashboard-function-roadmap-report.md", "release:manifest", "docs/health-dashboard-function-roadmap-report.md"],
  ["health-dashboard-backend-go-live", "dashboard", "Health dashboard backend go-live checklist", "docs/health-dashboard-backend-go-live-checklist.md", "docs/health-dashboard-backend-go-live-checklist.md", "release:manifest", "docs/health-dashboard-backend-go-live-checklist.md"],
  ["health-dashboard-indicator-center", "dashboard", "Health dashboard indicator center report", "docs/health-dashboard-indicator-center-report.md", "docs/health-dashboard-indicator-center-report.md", "release:manifest", "docs/health-dashboard-indicator-center-report.md"],
