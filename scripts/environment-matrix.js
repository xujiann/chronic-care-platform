...
const ENVIRONMENT_PROFILES = [
  ...
  },
  {
    ...
    envFile: ".env",
    requiredVars: ["NODE_ENV", "STORAGE_ENGINE", "SESSION_SECRETS", "INTEGRATION_GATEWAY_SECRET", "OIDC_ISSUER_URL", "OIDC_CLIENT_ID", "OIDC_CLIENT_SECRET", "SMS_GATEWAY_URL", "SMS_TEMPLATE_ID", "HOSPITAL_ADAPTER_SECRET", "HIS_ADAPTER_URL", "EMR_ADAPTER_URL", "LIS_ADAPTER_URL", "PACS_ADAPTER_URL", "APPOINTMENT_ADAPTER_URL", "OBJECT_STORAGE_GATEWAY_URL", "OBJECT_STORAGE_BUCKET", "OBJECT_STORAGE_SIGNING_SECRET", "FINANCIAL_GATEWAY_SECRET", "PAYMENT_GATEWAY_URL", "INSURANCE_GATEWAY_URL", "CERTIFICATE_GATEWAY_URL", "AUDIT_EXPORT_PATH", "CUTOVER_SITE_INTERFACE_SIGNOFF", "CUTOVER_INSURANCE_CERTIFICATE_SIGNOFF", "CUTOVER_MONITORING_SIGNOFF", "CUTOVER_DR_REHEARSAL_SIGNOFF"],
