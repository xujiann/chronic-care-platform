...
const ENVIRONMENT_PROFILES = [
  ...
  },
  {
    ...
    owner: "platform-ops",
    envFile: ".env.staging",
    requiredVars: ["NODE_ENV", "STORAGE_ENGINE", "SESSION_SECRETS", "INTEGRATION_GATEWAY_SECRET", "OIDC_ISSUER_URL", "OIDC_CLIENT_ID", "OIDC_CLIENT_SECRET", "IDENTITY_DIRECTORY_URL", "IDENTITY_DIRECTORY_TOKEN", "SMS_GATEWAY_URL", "SMS_TEMPLATE_ID", "HOSPITAL_ADAPTER_SECRET", "HIS_ADAPTER_URL", "EMR_ADAPTER_URL", "LIS_ADAPTER_URL", "PACS_ADAPTER_URL", "APPOINTMENT_ADAPTER_URL", "OBJECT_STORAGE_GATEWAY_URL", "OBJECT_STORAGE_BUCKET", "OBJECT_STORAGE_SIGNING_SECRET", "FINANCIAL_GATEWAY_SECRET", "PAYMENT_GATEWAY_URL", "INSURANCE_GATEWAY_URL", "CERTIFICATE_GATEWAY_URL", "SIEM_ENDPOINT", "SIEM_SIGNING_SECRET", "AUDIT_EXPORT_PATH", "DEPLOYMENT_SECRET_PROVIDER", "DEPLOYMENT_RELEASE_ID", "DEPLOYMENT_ARTIFACT_DIGEST", "POSTGRES_SYNC_MODE", "POSTGRES_SSL_MODE"],
