...
const ENVIRONMENT_PROFILES = [
  {
    ...
    owner: "product-demo",
    envFile: ".env.example",
    requiredVars: ["PORT", "NODE_ENV", "STORAGE_ENGINE", "SESSION_SECRETS", "SESSION_STORE", "SESSION_EXPIRED_RETENTION_DAYS", "SESSION_REVOKED_RETENTION_DAYS", "SESSION_CLEANUP_INTERVAL_MS", "INTEGRATION_GATEWAY_SECRET"],
    blockedVars: [],
