...
function buildDigitalHospitalStandardsReadiness(options = {}) {
  ...
  const checks = [
    ...
    check("digitalHospital:roleGuard", html.includes('src="./page-auth-bootstrap.js" data-roles="commission"') && accessPolicy.includes('"digital-hospital-standards.html": entry("数智医院标准", ["commission"]'), "commission-only route guard is wired through the central policy"),
