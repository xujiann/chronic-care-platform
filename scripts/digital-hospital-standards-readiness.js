...
function buildDigitalHospitalStandardsReadiness(options = {}) {
  ...
  const checks = [
    ...
    check("digitalHospital:roleGuard", html.includes('requireRole(["commission"])') && accessPolicy.includes('"digital-hospital-standards.html": entry("数智医院标准", ["commission"]'), "commission-only route guard is wired through the central policy"),
