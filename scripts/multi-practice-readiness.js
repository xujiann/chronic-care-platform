...
function buildMultiPracticeReadinessReport(options = {}) {
  ...
  const checks = [
    ...
    { id: "multiPractice:doctorAccountGuard", passed: hasAll(doctorPortal, ["requireRole([\"institution\"])", "requireAccountType([\"doctor\"])"]) && hasAll(readText("auth.js"), ["function requireAccountType", "pageName === \"doctor.html\"", "accountType === \"doctor\""]), detail: "doctor workbench is limited to institution-domain doctor accounts" },
