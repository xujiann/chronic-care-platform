...
function buildImagingCloudReadinessReport(options = {}) {
  const sources = options.sources || {
    ...
    auth: read("auth.js"),
    accessPolicy: read("access-control-policy.js"),
  ...
  const checks = [
    ...
    check("ui:auth-route", sources.accessPolicy.includes('"imaging-cloud.html": entry("影像云", ["commission", "institution", "county", "citizen"]'), "central role policy includes commission, institution, county and citizen", "ui"),
