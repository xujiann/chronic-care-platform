...
const RESPONSIBILITY_MATRIX = Object.freeze([
  ...
  Object.freeze({ capability: "formal-grouping", accountable: "insurance-payment-policy", responsible: ["official-grouper-operator"], consulted: ["hospital-medical-records"], evidence: ["signed-grouper-receipt", "trusted-transport-callback", "callback-replay-ledger", "scheme-version", "case-input-digest", "job-state-projection", "job-result-ledger-cross-check", "dead-letter-state-projection", "redacted-operations"] }),
