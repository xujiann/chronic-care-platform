...
const RESPONSIBILITY_MATRIX = Object.freeze([
  ...
  Object.freeze({ capability: "formal-grouping", accountable: "insurance-payment-policy", responsible: ["official-grouper-operator"], consulted: ["hospital-medical-records"], evidence: ["signed-grouper-receipt", "scheme-version", "case-input-digest", "job-state-projection", "dead-letter-state-projection", "redacted-operations"] }),
