...
- 首批建立六图状态层、完整追踪链、四级门禁、十条黄金场景及六域生产准入矩阵。GOV-002 已由 PR #256/CI run 34091091690、GOV-005 已由 PR #277/CI run 34233229053 完成仓库集成并关闭；OPS-020 至 OPS-024 及 TEST-010/TEST-011 也均绑定独立已合并 PR、全绿 required CI 与非生产证据并关闭。当前仅 GOV-006 在 Draft PR #280 保持“待集成/已验证”，WIP 为 1/5；它必须在最终 head 独立评审、required CI 和合并完成后才能关闭。OPS-015/OPS-016/OPS-017/OPS-018 等上位运行能力缺口及现场生产证据继续由六图显式追踪。
