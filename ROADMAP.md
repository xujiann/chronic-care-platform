...
| 优先级 | 事项 | 状态 | 进入实现条件 |
|---:|---|---|---|
| 0 | T00 治理基线迁移 | 文档、专项门禁与 review 完成，待提交审批 | 全量测试基线误报已登记；获得授权后提交并创建 PR |
| 1 | 静态内容 allowlist 与快照隔离 | Proposed / P0 | ADR 接受；资产/缓存/Pages/回滚计划和负向测试 |
...
| 7A | 临床五个可治理子域 | 治理切片完成，急救/血液/影像首用例已迁移 / P1 | Accepted ADR；保持协议兼容，按子域逐用例迁移 |
