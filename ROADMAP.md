...
- GOV-007 及 OPS-025～OPS-028 已完成仓库集成，中央 #286 绑定 head `a409bfb4` / CI 34339809407 / merge `8e400c4c`。GOV-008 四路 OPS-029～OPS-032 已由 #294/#295/#291/#292 串行集成至 main `7bd15793`，各最终 CI 九项成功；精确 head、CI、合并与验证边界见 `docs/lifecycle-governance.md`。仅中央 #293 待集成，WIP 1/5，其他候选未批准不得实施。三条居民写 POST 后端缺口仍归 OPS-017；GS-01～GS-10 系统证据映射尚未完成、保持未建设，上位运行能力及现场缺口继续追踪，不将局部修复解释为全平台完成。
