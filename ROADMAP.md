...
- 首批建立六图状态层、完整追踪链、四级门禁、十条黄金场景及六域生产准入矩阵。GOV-002 已由 PR #256 与 CI run 34091091690 完成“已关闭、已集成”；GOV-005 已由 PR #277 与 CI run 34233229053 完成六图反向覆盖和治理编号闭集并关闭。影像 OPS-020 已由 PR #278/CI run 34308801123、居民 OPS-021 已由 PR #279/CI run 34309613178 完成仓库集成并关闭；当前 GOV-006 登记体检 OPS-022 与区域运营 E2E 稳定化 TEST-010，三项在制任务为 WIP 3/5 且写范围互不重叠。仍未闭合的能力和生产证据继续作为六图差距显式映射。
