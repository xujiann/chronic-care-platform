...
- GOV-007 及四路 OPS-025～OPS-028 已完成仓库集成，中央 #286 绑定 head `a409bfb4` / CI 34339809407 / merge `8e400c4c`；精确证据见 `docs/lifecycle-governance.md`。下一批 GOV-008 已登记 OPS-029 居民会话隔离、OPS-030 账号筛选快照、OPS-031 驾驶舱全量统计与预览分离、OPS-032 质量快照失效，WIP 5/5；其他候选排队，未批准不得实施。候选队列仍非全平台缺口穷尽证明；GS-01～GS-10 系统证据映射尚未完成，保持未建设，上位运行能力及现场缺口继续追踪。
