...
- 当前对账值为 SQLite head v17/38 张非内部表、生产 API 636 项/363 个写入口/325 个行为证明缺口/327 个总复核项、首批范围 `FROZEN-NO-GO` 且范围内 API/集合复核与仓库迁移计划缺口均为 0、Markdown 280 份（210 current、68 snapshot、2 superseded）。
...
`repository-governance-v1` 从 Git 路径派生；当前闭集为 280 份 Markdown：210 份 `current`、68 份
