...
`digital-hospital-standard-platform/` is the public GitHub Pages entry for the v0.12 new-standard prototype. It adds pilot operations, pilot collaboration, pilot assessment, the evaluation assistant, rollout readiness, operational monitoring, 57 trial indicators, tiered review, scoring and rectification, and downloadable interface packages. The evaluation assistant now combines knowledge-version approval, retrieval traces, model-call audit records, versioned evaluation suites, measurable quality gates, gated candidate releases, and rollback evidence while keeping all generated advice subject to human confirmation.
