...
`digital-hospital-standard-platform/` is the public GitHub Pages entry for the v0.11 new-standard prototype. It adds pilot operations, pilot collaboration, pilot assessment, the evaluation assistant, rollout readiness, operational monitoring, 57 trial indicators, tiered review, scoring and rectification, and downloadable interface packages. The evaluation assistant now governs knowledge-version approval, retrieval traces, and model-call audit records while keeping cited answers, anomaly explanations, rectification suggestions, and review-risk signals subject to human confirmation.
