...
`docs/陪诊信息平台功能责任与下一步计划.md` lists the current escort functions, responsible departments, evidence, next planned development items, and go-live responsibility split; the same responsibility board is visible in `escort.html` for on-site review.
