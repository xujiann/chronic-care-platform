...
`digital-hospital-standard-platform/` is the public GitHub Pages entry for the v0.14 new-standard prototype. It adds pilot operations, pilot collaboration, pilot assessment, the evaluation assistant, rollout readiness, operational monitoring, 57 trial indicators, tiered review, scoring and rectification, and downloadable interface packages. The evaluation assistant now combines knowledge-version approval, retrieval traces, model-call audit records, versioned evaluation suites, measurable quality gates, canary traffic expansion, online quality windows, incident-driven rollback, human-reviewed feedback, labeled improvement samples, and regression-verified improvement cycles while keeping all generated advice subject to human confirmation.
