...
`digital-hospital-standard-platform/` is the public GitHub Pages entry for the v0.15 new-standard prototype. It adds pilot operations, pilot collaboration, hospital onboarding and integration certification, pilot assessment, the evaluation assistant, rollout readiness, operational monitoring, 57 trial indicators, tiered review, scoring and rectification, and downloadable interface packages. The new integration workbench connects access applications, source-system connectors, credential rotation, connectivity probes, OpenAPI contract certification, field mapping, de-identification sampling, issue resolution, and audited go-live approval in one pilot workflow.
