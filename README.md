...
- API evidence: `/api/quality-safety/dashboard`, `/api/quality-safety/interface-standard`, `/api/quality-safety/issues/:id/dispatch`, `/api/quality-safety/rectifications/:id/feedback`, `/api/quality-safety/rectifications/:id/review`, `/api/quality-safety/critical-values/:id/acknowledge`, `/api/quality-safety/critical-values/:id/dispose`, `/api/quality-safety/clinical-pathways/:id/review`, `/api/quality-safety/site-signoffs/:id/review`
...
- Release artifacts: `quality-safety-report.md` / `quality-safety-report.json` from `npm.cmd run quality-safety:report`, plus `quality-safety-interface-standard.md` / `quality-safety-interface-standard.json` from `npm.cmd run quality-safety:interface-standard`
